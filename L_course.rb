...
# => [motor_w_count,lm,rm,KP,KI,KD,i,threshold,gyro_offset]	-：黒寄り
    ...
    [ 6000, 1, 1,0.996,0.139,0.034,  60, -5,  -5], # 1carb
    [ 10000, 1, 1,0.996,0.139,0.034,  75, -5,  -5], # 1carb
    [ 13000, 1, 1,0.126,0.162, 0.04, 75,  5,  -5], # 2st_straight
    #[ 13700, 1, 1,  2.4,0.176,0.044,  55, -5,  -5], # 2carb_1
    [14000, 1, 1, 0.696,0.225,0.056,  100,  0, -5], # 2carb_mid
    [19000, 1, 1, 0.696,0.176,0.044,  60, -5,  -5], # 2carb_2
	[20000, 1, 1, 0.996,0.176,0.044,  60, -5,  -5],
