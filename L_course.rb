...
# => [motor_w_count,lm,rm,KP,KI,KD,i,threshold,gyro_offset]	-：黒寄り
    [    0, 1, 1,0.126,0.162, 0.04, 100,  0, 3], # 1st_straight
    [ 1000, 1, 1,0.126,0.162, 0.04, 100,  0, 3], # 1st_straight
    [ 6000, 1, 1,0.996,0.139,0.034,  60, -3,  0], # 1carb
    [ 10000, 1, 1,0.996,0.139,0.034,  75, -3,  0], # 1carb
    [ 13000, 1, 1,0.126,0.162, 0.04, 75,  12,  1], # 2st_straight
    #[ 13700, 1, 1,  2.4,0.176,0.044,  55, -5,  -5], # 2carb_1
    [14000, 1, 1, 0.696,0.225,0.056,  100,  0, -1], # 2carb_mid
    [19000, 1, 1, 0.696,0.176,0.044,  60, 3,  -1], # 2carb_2
		[20000, 1, 1, 0.996,0.176,0.044,  60, 3,  -1],
    [24500, 1, 1,0.126,0.162, 0.04,  100,  3,  1], # 3st_straight
    [26000, 1, 1,0.126,0.162, 0.04, 100,  3,  1], # 3st_straight
    # [15100, 1, 1,0.126,0.162, 0.04, 100,  5,  4], # test_3streat_start
    # [16000, 1, 1,0.126,0.162, 0.04, 100,  5,  8], # test_3streat
    [28000, 1, 1, 0.996, 0.17,0.042,  60,  3,  -2], # 3carb
    # [18600, 1, 1,  1.7,    1, 0.22,  50,  3,  0], # 3carb_old
    [30000, 1, 1,0.126,0.162, 0.04,  50, -3,  -2], # 4st_straight_goal
